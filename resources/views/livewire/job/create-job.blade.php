        ...
        this.$watch('step', () => {
          ...
          this.$nextTick(() => {
                ...
                <div class="flex justify-center space-x-4 text-sm font-medium">
                    @for($i = 1; $i <= 4; $i++) <div
                        class="px-4 py-2 rounded @if($step === $i) bg-blue-600 text-white @else bg-gray-200 text-gray-600 @endif">
                        Step {{ $i }}
                </div>
                @endfor
            </div>
            ...
            <div x-show="step === 1" x-transition x-cloak>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <label
                        class="flex w-full items-center space-x-2 cursor-pointer border p-2 rounded border-gray-400 hover:bg-gray-100 rounded-lg">
                        <input type="radio" value="{{ $key }}" x-model="type_job" class="text-blue-600">
                        <span>{{ $label }}</span>
                    </label>
                    @endforeach
                </div>
            ...
            <div x-show="step === 2" x-transition x-cloak>
                <h2 class="text-lg font-semibold mb-3">Detail Job: {{ strtoupper(str_replace('_', ' ', $type_job)) }}
                </h2>
                ...
                <div>
                    <div class="grid grid-cols-1 md:grid-cols-3 mb-3 gap-x-4">
                        ...
                        <div class="flex flex-col space-y-2">
                            ...
                            <input type="text" wire:model="customerCodeJob"
                                class="text-sm font-bold w-full border-2 border-gray-300 rounded-md focus:ring-0 focus:outline-none ">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div class="mb-4" wire:ignore>
                            ...
                            <select name="carrier" id="carrier" wire:model="carrierAirline"
                        ...
                        <div class="mb-4" wire:ignore>
                            ...
                            <select name="deliveryAgent" id="deliveryAgent_export" wire:model="deliveryAgent"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200 select2">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 ">
                            <div class="" wire:ignore>
                                ...
                                <select name="" id="servicesType" wire:model="servicesType"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                            ...
                            <div class="mb-4" wire:ignore>
                                ...
                                <select name="incoTerms" id="incoTerms" wire:model="incoTerms"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                    ...
                    <div class=" grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div class=" mb-4">
                            ...
                            <input type="text" id="flightVesselName" name="flightVesselName"
                                wire:model="flightVesselName"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                        ...
                        <div class="mb-4">
                            ...
                            <input type="text" id="flightVesselNo" name="flightVesselNo" wire:model="flightVesselNo"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                        ...
                        <div class="mb-4" hidden>
                            ...
                            <input type="text" id="ocean_vessel_feeder" name="ocean_vessel_feeder"
                                wire:model="ocean_vessel_feeder"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-3 ">
                            ...
                            <div class="">
                                ...
                                <input type="datetime-local" id=" estimearrival" name="estimearrival"
                                    wire:model="estimearrival"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                                @error('estimearrival')
                                <span class="text-red-500 text-sm">{{ $message }}</span>
                                @enderror
                            ...
                            <div class="">
                                ...
                                <input type="datetime-local" id=" estimedelivery" name="estimedelivery"
                                    wire:model="estimedelivery"
                                    class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                    ...
                    <div class="grid grid-cols-3 gap-3">
                        <div>
                            ...
                            <input type="text" id="payableAtJob" name="payableAtJob" wire:model="payableAtJob"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                            @error('payableAtJob')
                            <span class="text-red-500 text-sm">{{ $message }}</span>
                            @enderror
                        ...
                        <div wire:ignore>
                            ...
                            <select name="freightTypeJob" id="freightTypeJob" wire:model="freightTypeJob"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                                <option value=""></option>
                        ...
                        <div class="" wire:ignore>
                            ...
                            <select name="" id="cross_trade" wire:model="cross_trade"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                                <option value=""></option>
                    ...
                    <!-- Select Port -->
                    <div
                        class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4 border rounded-md p-4 border-1 border-gray-300 mt-5">
                        <div class="port-container" data-model="port_of_loading" data-radio-name="i nputTypeLoading"
                            wire:ignore wire:change="port_of_loading">
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <label class="cursor-pointer">
                                        <input type="radio" value="select" name="inputTypeLoading" checked> Select from
                                        List
                                    </label>
                                    <label class="cursor-pointer">
                        ...
                        <div class="port-container" data-model="port_of_final" data-radio-name="inputTypeFinal"
                            wire:ignore wire:change="port_of_final">
                            <h2 class="text-lg font-semibold">Port Of Final / POF</h2>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Select or Input Port</label>
                                <div class="flex items-center gap-3">
                                    <label class="cursor-pointer">
                                        <input type="radio" value="select" name="inputTypeFinal" checked> Select from
                                        List
                                    </label>
                                    <label class="cursor-pointer">
                        ...
                        <div class="port-container" data-model="place_of_receipt" data-radio-name="inputTypeReceipt"
                            wire:ignore wire:change="place_of_receipt">
                            <h2 class="text-lg font-semibold">Place Of Receipts <span class="text-red-500">*</span></h2>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Select or Input Port</label>
                                <div class="flex items-center gap-3">
                                    <label class="cursor-pointer">
                                        <input type="radio" value="select" name="inputTypeReceipt" checked> Select from
                                        List
                                    </label>
                                    <label class="cursor-pointer">
                        ...
                        <div class="port-container" data-model="port_of_receipt" data-radio-name="inputTypePReceipt"
                            wire:ignore wire:change="port_of_receipt">
                            <h2 class="text-lg font-semibold">Port Of Receipt / POR <span class="text-red-500">*</span>
                            </h2>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Select or Input Port</label>
                                <div class="flex items-center gap-3">
                                    <label class="cursor-pointer">
                                        <input type="radio" value="select" name="inputTypePReceipt" checked> Select from
                                        List
                                    </label>
                                    <label class="cursor-pointer">
                        ...
                        <!-- Port Of Discharge -->
                        <div class="port-container" data-model="port_of_discharge" data-radio-name="inputTypeDischarge"
                            wire:ignore>
                            <h2 class="text-lg font-semibold">Port Of Discharge / POD <span
                                    class="text-red-500">*</span></h2>
                            <div>
                                <label class="block text-sm font-medium text-gray-700">Select or Input Port</label>
                                <div class="flex items-center gap-3">
                                    <label class="cursor-pointer">
                                        <input type="radio" value="select" name="inputTypeDischarge" checked> Select
                                        from List
                                    </label>
                                    <label class="cursor-pointer">
                        ...
                        <!-- Port Of Delivery -->
                        <div class="port-container" data-model="place_of_delivery" data-radio-name="inputTypeDelivery"
                            wire:ignore>
                            ...
                            <div>
                                ...
                                <div class="flex items-center gap-3">
                                    <label class="cursor-pointer">
                                        <input type="radio" value="select" name="inputTypeDelivery" checked> Select from
                                        List
                                    </label>
                                    <label class="cursor-pointer">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 ">
                        <div>
                            ...
                            <textarea type="text" id="remarksJobDetailJobs" name="remarksJobDetailJobs"
                                wire:model="remarksJobDetailJobs"
                        ...
                        <div wire:ignore>
                            <div>
                                ...
                                <select name="jobEmployee" id="jobEmployee" wire:model="jobEmployee"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                                    <option value=""></option>
                            ...
                            <div>
                                ...
                                <select name="hazardousType" id="hazardousType" x-model="hazardousType"
                                    wire:model="hazardousType"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                                    <option value=""></option>
                                    <option value="yes">Yes</option>
                                    <option value="no">No</option>
                        ...
                        <template x-if="hazardousType === 'yes'">
                            <div wire:ignore x-init="init()">
                                ...
                                <select name="hazardousType" id="hazardousClassType" wire:model="hazardousClassType"
                                    class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                                    <option value=""></option>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div class="mb-4" wire:ignore>
                            ...
                            <select name="originAgent_import" id="originAgent_import" wire:model="originAgent"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200 select2">
                                <option value="">Select agent</option>
                                @foreach($dagentsJob as $da)
                                <option value="{{ $da->id }}">{{ $da->name }}</option>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        <div class="mb-4" wire:ignore>
                            ...
                            <select name="airline" id="airline" wire:model="carrierAirline"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                                <option value="">Select Carrier</option>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                        ...
                        <div class="mb-4" wire:ignore>
                            ...
                            <select name="originAgent" id="originAgent_import" wire:model="originAgent"
                                class="block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200 select2">
                                <option value="">Select agent</option>
                ...
                <div>
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3 mb-4">
                        ...
                        <div class="flex flex-col space-y-3 rounded-md">
                            <label>HAWB No</label>
                            <input type="text" wire:model="houseJobBillLadingNo" placeholder="Enter MBL"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                            @error('houseJobBillLadingNo')<div class="text-red-500 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
                        <div class="flex flex-col space-y-3 rounded-md">
                            <label>HAWB Date</label>
                            <input type="date" wire:model="houseJobBillLadingDate" placeholder="Enter HBL DATE"
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:ring focus:ring-blue-200">
                            @error('houseJobBillLadingDate')<div class="text-red-500 text-sm">{{ $message }}</div>
                            @enderror
                        </div>
                    </div>
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-3">
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                        ...
                        <div class="space-y-6 ">
                            ...
                            <div class="flex flex-items grid grid-cols-3">
                                ...
                                <p class="col-span-2">: {{ \Carbon\Carbon::parse($estimearrival)->format('d M Y H:i') }}
                                </p>
                            </div>
                            <div class="flex flex-items grid grid-cols-3">
                                <p class="col-span-1"><strong>ETD / Estimate Time Departure</strong> </p>
                                <p class="col-span-2">: {{ \Carbon\Carbon::parse($estimedelivery)->format('d M Y H:i')
                                    }} </p>
                            </div>
                        </div>

                        <div class="space-y-6">
                            @if(in_array($type_job, ['ocean_fcl_export', 'ocean_lcl_export',
                            'ocean_fcl_import','ocean_lcl_import']))
